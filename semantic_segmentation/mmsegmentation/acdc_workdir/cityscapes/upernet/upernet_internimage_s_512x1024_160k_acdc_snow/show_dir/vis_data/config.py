...
launcher = 'none'
load_from = '../checkpoint_files/upernet/upernet_internimage_s_512x1024_160k_cityscapes.pth'
log_level = 'INFO'
...
visualizer = dict(
    name='visualizer',
    save_dir=
    './acdc_workdir/cityscapes/upernet/upernet_internimage_s_512x1024_160k_acdc_snow/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../acdc_workdir/cityscapes/upernet/upernet_internimage_s_512x1024_160k_acdc_snow'
