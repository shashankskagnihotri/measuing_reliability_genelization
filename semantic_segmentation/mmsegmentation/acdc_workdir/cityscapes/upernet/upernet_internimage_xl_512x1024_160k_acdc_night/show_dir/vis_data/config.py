...
visualizer = dict(
    name='visualizer',
    save_dir=
    './acdc_workdir/cityscapes/upernet/upernet_internimage_xl_512x1024_160k_acdc_night/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../acdc_workdir/cityscapes/upernet/upernet_internimage_xl_512x1024_160k_acdc_night'
