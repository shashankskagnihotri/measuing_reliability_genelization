...
visualizer = dict(
    name='visualizer',
    save_dir=
    './acdc_workdir/cityscapes/upernet/upernet_internimage_b_512x1024_160k_acdc/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../acdc_workdir/cityscapes/upernet/upernet_internimage_b_512x1024_160k_acdc'
