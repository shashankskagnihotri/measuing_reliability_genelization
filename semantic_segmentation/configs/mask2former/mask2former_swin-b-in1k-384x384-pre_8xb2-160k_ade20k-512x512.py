_base_ = [
    '../../mmsegmentation/configs/_base_/default_runtime.py', '../../mmsegmentation/configs/_base_/datasets/ade20k_640x640.py' #it was ade20k_640x640 before I change it
]
...
crop_size = (512, 512) # I change crop size it was 640x640 before
