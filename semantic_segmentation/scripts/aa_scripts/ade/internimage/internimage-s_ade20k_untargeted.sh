...
#SBATCH --job-name=internimage-s_ade20k_untargeted
#SBATCH --output=slurm/attacks/ade/upernet/internimage-s_ade20k_untargeted-%a-%A.out
#SBATCH --array=0-2
