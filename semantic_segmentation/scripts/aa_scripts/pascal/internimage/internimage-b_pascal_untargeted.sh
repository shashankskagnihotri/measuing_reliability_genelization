...
#SBATCH --job-name=internimage-b_pascal_untargeted
#SBATCH --output=slurm/attacks/pascal/upernet/internimage-b_pascal_untargeted-%a-%A.out
#SBATCH --array=0-2
