...
#SBATCH --job-name=internimage-xl_cityscapes_untargeted
#SBATCH --output=slurm/attacks/cityscapes/upernet/internimage-xl_cityscapes_untargeted-%a-%A.out
#SBATCH --array=0-2
