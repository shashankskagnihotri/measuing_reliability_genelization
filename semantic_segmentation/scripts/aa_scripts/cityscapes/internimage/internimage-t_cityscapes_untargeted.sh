...
#SBATCH --job-name=internimage-t_cityscapes_untargeted
#SBATCH --output=slurm/attacks/cityscapes/upernet/internimage-t_cityscapes_untargeted-%a-%A.out
#SBATCH --array=0-2
