...
#SBATCH --job-name=internimage-l_cityscapes_untargeted
#SBATCH --output=slurm/attacks/cityscapes/upernet/internimage-l_cityscapes_untargeted-%a-%A.out
#SBATCH --array=0-2
